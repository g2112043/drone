...
topics.subTopic(1,:) = {'/Drp5_12/front_rplidar_node/scan_front','sensor_msgs/LaserScan',1e6};
topics.subTopic(2,:) = {'/Drp5_12/behind_rplidar_node/scan_behind' ,'sensor_msgs/LaserScan',1e6};
